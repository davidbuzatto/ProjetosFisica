...
public class JanelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnConfiguracoesGrafico = new javax.swing.JButton();
        ...
        setTitle("Projeto de Física - Experimentos Virtuais - Gráficos");
        ...
        btnConfiguracoesGrafico.setText("Configurações do Gráfico");
        btnConfiguracoesGrafico.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnConfiguracoesGraficoActionPerformed(evt);
            }
        });
        ...
        painelValoresLayout.setHorizontalGroup(
            ...
            .addGroup(painelValoresLayout.createSequentialGroup()
                ...
                .addGroup(painelValoresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnConfiguracoesGrafico, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        painelValoresLayout.setVerticalGroup(
            ...
            .addGroup(painelValoresLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnConfiguracoesGrafico)
...
private void btnLimparPontosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparPontosActionPerformed
    ...
    if ( JOptionPane.showConfirmDialog( 
            this, "Deseja mesmo limpar todos os pontos?", 
            "Confirmação", JOptionPane.YES_NO_OPTION ) == JOptionPane.YES_OPTION ) {
        painelGrafico.limparTodosOsPontos();
    }
...
private void btnConfiguracoesGraficoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfiguracoesGraficoActionPerformed
    
    DialogoConfiguracoesGrafico dialogo = new DialogoConfiguracoesGrafico( 
            this, painelGrafico, true );
    dialogo.setVisible( true );
    painelDesenho.repaint();
    painelGrafico.repaint();
    
}//GEN-LAST:event_btnConfiguracoesGraficoActionPerformed
    ...
    private class Animador implements Runnable {
        ...
        public void run() {
            ...
            btnConfiguracoesGrafico.setEnabled( false );
            ...
            while ( executar ) {
                ...
                if ( sensor2Ativado ) {
                    ...
                    double deltaS = posicaoSensor2 - posicaoSensor1;
                    double deltaT = tempoSensor2 - tempoSensor1;
                    double velocidade = deltaS / deltaT;

                    painelGrafico.adicionarPontoEspacoVersusTempo(
                            deltaT, 
                            deltaS );

                    painelGrafico.adicionarPontoAceleracaoVersusTempo(
                            deltaT, 
                            aceleracao );

                    painelGrafico.adicionarPontoVelocidadeVersusTempo(
                            deltaT, 
                            velocidade );
...
//                }
            ...
            btnConfiguracoesGrafico.setEnabled( true );
    ...
    private javax.swing.JButton btnConfiguracoesGrafico;
